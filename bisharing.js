(function () {
    ...
    class BiSharing extends HTMLElement {
        ...
        selectToShare() {
            ...
            liframe.setAttribute('sandbox', "allow-same-origin allow-scripts allow-forms allow-popups");
    ...
    return function o(a, s, u) {
        ...
        4: [function (e, t, r) {
            ! function (e, t, d, p, f, c, h, v, m, g, y) {
                ...
                t.saveItemByUriUpload = function (e, t, r, i) {
                    if (i.apiEndpoint === d.default.filesV2 || i.apiEndpoint === d.default.graph_odb) return new y.Promise(function (e, t) {
                        t(new h.default(p.default.unsupportedFeature, "URL upload not supported for OneDrive business"))
                    });
                    var n, o = m.appendToPath(b(e, i.apiEndpointUrl), "children"),
                        a = {
                            Prefer: "respond-async"
                        };
                    a.Authorization = "bearer " + i.accessToken;
                    t[(n = i.apiEndpoint, n === d.default.graph_odb || n === d.default.graph_odc ? "@microsoft.graph.sourceUrl" : "@content.sourceUrl")] = r;
                    t.file = {};
                    ...
                    return m.isPathDataUrl(r) ? (u = l, new y.Promise(function (i, n) {
                        u.start(function (e, t) {
                            if (200 === t || 201 === t) {
                                ...
                                i(r)
                            } else n(new h.default(p.default.webRequestFailure, v.format("file uploading failed by data uri with HTTP status: {0}", t)))
                        }, function (e, t, r) {
                            n(new h.default(p.default.webRequestFailure, v.format("file uploading failed with HTTP status: {0}", t)))
                        })
                    })) : m.isPathFullUrl(r) ? (s = l, new y.Promise(function (i, n) {
                        s.start(function (e, t) {
                            if (202 === t) {
                                ...
                                i(r)
                            } else n(new h.default(p.default.webRequestFailure, v.format("create upload by url job failed with HTTP status: {0}", t)))
                        }, function (e, t, r) {
                            n(new h.default(p.default.webRequestFailure, v.format("create upload by url job failed with HTTP status: {0}", t)))
                        })
                    })).then(function (e) {
                        return (s = e, new y.Promise(function (n, a) {
                            ! function t(r, i) {
                                if (!r--) {
                                    i *= 2;
                                    r = E
                        ...
                        return this.buildOauthPromise(e).then(function (e) {
                            ...
                            if ("success" === e.type) {
                                ...
                                var s = {
                                    ...
                                    u = void 0;
                                if (!t.needAPICall() || i && "rps" === t.accessToken.toLowerCase()) u = v.Promise.resolve(s);
                                else {
            ...
            ! function (e, t, r, a, u, s, l, d, c, p, i, f) {
                ...
                function T(e, t) {
                    ...
                    e[m] ? function (e) {
                        ...
                        var r, i, n;
                        var o;
                        if (e.switchAccount) t = f.appendQueryString(t, "prompt", "select_account");
                        else if (e.loginHint) {
                ...
                function b(e, t) {
                    ...
                    } else s.throwError(new p.default(l.default.badResponse, "missing state parameter from Oauth redirect")).exposeToPublic()
                }
                t.auth = function (e, a) {
            ...
            ! function (e, t, r, n, o, i, a, s, u, l, d) {
                ...
                var c = function (i) {
                    ...
                    t.prototype.makeApiRequest = function (e) {
                        if (this.invokerOptions.action === u.default.share) return this.shareItems(e);
        ...
        9: [function (e, t, r) {
            ! function (e, t, r, f, h, i, n, o, a, s, u, v) {
                ...
                var l = function () {
                    function e(e, t) {
                        if (e === r.default.graph_odc || e === r.default.msa) this.url = s.appendQueryStrings("https://onedrive.live.com/", {
                            v: "2"
                        });
                    ...
                    e.prototype.invokePickerUX = function (d, c) {
                        ...
                        return new u.Promise(function (u, e) {
                                ...
                                if (e.origin === t[0] + "//" + t[2]) {
                                    ...
                                    if (0 === i.indexOf(m) && e.source === r.getReceiver()) {
                                        var n = JSON.parse(i.substring(m.length)),
                                            ...
                                            s = n.type;
                                        if (o === d.id)
                                            if ("initialize" === s) r.send("[OneDrive-ToPicker]" + JSON.stringify({
                                                pickerId: o,
                                                conversationId: a,
                                                type: "activate"
                                            }), e.origin);
                            ...
                            //END PATCH//
                            //PATCH BY BIEXCELLENCE//							
                            if ((d.entryLocation.sharePoint.link) && (d.entryLocation.sharePoint.link != "") && (d.entryLocation.sharePoint.link != "undefined")) {
                                // delete trailing /
                                var llink = d.entryLocation.sharePoint.link;
                                if (llink[llink.length - 1] == '/') {
                                    llink = llink.substr(0, llink.length - 1);
                                }

                                // extract domain from link
                                var lurl = new URL(llink);

                                // different URL setups
                                if (lurl.pathname.split("/").length < 4) {
                                    // if only site is specified
                                    r += s.appendQueryString(r, "id", lurl.href.split("%20").join(" "));
                                    r = s.appendQueryString(r, "view", "2");
                                } else {
                                    // if folder of the site is specified
                                    r += s.appendQueryString(r, "id", lurl.pathname.split("%20").join(" "));
                                    r = s.appendQueryString(r, "listurl", lurl.href.split("%20").join(" "));
                                }
                            }
                            //END PATCH//
                            ...
                            i.style.width = "100%";
                            i.style.height = "100%";
                            i.sandbox = "allow-same-origin allow-scripts allow-forms allow-popups";
                            i.src = r;
        ...
        14: [function (e, t, r) {
            ! function (e, t, n, a, s, u, l, o, d, c, p, f) {
                "use strict";
                Object.defineProperty(t, "__esModule", {
                    value: !0
                });
                var r = new RegExp("^[a-fA-F\\d]{8}-([a-fA-F\\d]{4}-){3}[a-fA-F\\d]{12}$"),
                    i = function () {
                        function i(e) {
                            ...
                            this.clientId = p.validateType(e.clientId, a.default.TYPE_STRING);
                            var t = p.validateCallback(e.cancel, !0);
                            this.cancel = function () {
                                o.default.logMessage("user cancelled operation");
                                t && n.invokeAppCallback(t, !0)
                            };
                            var r = p.validateCallback(e.error, !0);
                            this.error = function (e) {
                                if (!r) throw e;
                                n.invokeAppCallback(r, !0, e)
                            };
                            this.parseAdvancedOptions(e);
                            this.redirectUri = this.redirectUri || f.trimUrlQuery(window.location.href);
                            this.endpointHint = this.endpointHint || s.default.aad;
                            i.checkClientId(this.clientId)
                        }
                        i.checkClientId = function (e) {
                            e ? r.test(e) ? o.default.logMessage("parsed client id: " + e) : u.throwError(new d.default(l.default.unknown, c.format("invalid format for client id '{0}' - AAD: 32 characters (HEX) GUID", e))) : u.throwError(new d.default(l.default.unknown, "client id is missing in options"))
                        };
                        i.prototype.needOauth = function () {
                            return this.needAPICall() && !this.accessToken || this.endpointHint === s.default.aad
                        };
                        i.prototype.parseAdvancedOptions = function (e) {
                            if (e.advanced) {
                                if (e.advanced.redirectUri) {
                                    f.validateRedirectUrlHost(e.advanced.redirectUri);
                                    this.redirectUri = e.advanced.redirectUri
                                }
                                if (e.advanced.queryParameters) {
                                    var t = f.readUrlParameters("?" + e.advanced.queryParameters);
                                    for (var r in t) "select" !== r.toLowerCase() && "expand" !== r.toLowerCase() && u.throwError(new d.default(l.default.optionsError, c.format("unexpected query key: {0} is found in advanced.queryParameters", r)));
                                    var i = t.select,
                                        n = t.expand;
                                    i && n ? this.queryParameters = c.format("expand={0}&select={1}", n, i) : n ? this.queryParameters = c.format("expand={0}", n) : i && "select=" + i.split(",").sort().join(",") !== a.default.DEFAULT_QUERY_ITEM_PARAMETER && (this.queryParameters = c.format("select={0}", i))
                                }
                                if (e.advanced.endpointHint) {
                                    if (e.advanced.endpointHint.toLowerCase() === a.default.VROOM_ENDPOINT_HINT) {
                                        ...
                                        var o = p.validateType(e.advanced.endpointHint, "string", !1);
                                        f.validateUrlProtocol(o);
                                ...
                                if (e.advanced.iframeParentDiv) {
                                    e.advanced.iframeParentDiv.nodeName && "div" === e.advanced.iframeParentDiv.nodeName.toLowerCase() || u.throwError(new d.default(l.default.optionsError, "the iframe's parent div element is not a DOM object")).exposeToPublic();
                        ...
                        i.prototype.parseNavigationOptions = function (e) {
                            if (e) {
                                ...
                                if (t) {
                                    if (t.sharePoint) {
                                        var r = t.sharePoint,
                                            i = r.sitePath,
                                            n = r.listPath;
                                        i && f.validateUrlProtocol(i, ["HTTPS"]);
                                        n && f.validateUrlProtocol(n, ["HTTPS"])
                                    }
            ...
            ! function (e, t, a, s, r, i, n, o, u, l, d, c, p, f, h) {
                ...
                var v = function (o) {
                    ...
                    e.prototype._setFileInfo = function (e) {
                        ...
                        } else i.throwError(new l.default(n.default.optionsError, "please specified one type of resource to save"))
                    };
                    return e
                }(o.default);
                t.default = v
            ...
            ! function (e, t, i, a, s, u, l, d, c) {
                ...
                t.validateType = function (e, t, r, i, n) {
                    ...
                    if (void 0 === e) {
                        ...
                        } else a.throwError(new d.default(s.default.typeError, "object was missing and not optional"));
                        return null
                    }
                    var o = typeof e;
                    if (o !== t) {
        ...
        32: [function (e, t, r) {
            ! function (e, t, i, o, a, s, u) {
                ...
                function n(e, t, r) {
                    ...
                    var i = "";
                    for (var n in t) i += (i.length ? "&" : "") + u.format("{0}={1}", encodeURIComponent(n), encodeURIComponent(t[n]));
                    return e + i
                }
                ...
                t.generateNonce = function () {
                    for (var e = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789", t = "", r = 0; r < i.default.NONCE_LENGTH; r++) t += e.charAt(Math.floor(Math.random() * e.length));
                    return t
                };
                ...
                t.validateRedirectUrlHost = function (e) {
                    f(e); - 1 < e.indexOf("://") ? e.split("/")[2] !== window.location.host && o.throwError(new s.default(a.default.optionsError, "redirect uri is not in the same domain as picker sdk")).exposeToPublic() : o.throwError(new s.default(a.default.optionsError, "redirect uri is not an absolute url")).exposeToPublic()
                };
        ...
        34: [function (x, e, t) {
            ...
            r = this, i = function () {
                ...
                }() : void 0 === e && "function" == typeof x ? function () {
                    try {
                        var e = x("vertx");
                ...
                function P(e, t, r) {
                    t.constructor === e.constructor && r === v && t.constructor.resolve === m ? (o = e, (a = t)._state === E ? U(o, a._result) : a._state === w ? C(o, a._result) : S(a, void 0, function (e) {
                        return k(o, e)
                    }, function (e) {
                        return C(o, e)
                    })) : r === T ? C(e, T.error) : void 0 === r ? U(e, t) : l(r) ? (i = t, n = r, s(function (t) {
                        var r = !1,
                            e = function (e, t, r, i) {
                                try {
                                    e.call(t, r, i)
                ...
                function H(e, t, r, i) {
                    ...
                    t._state !== _ || (n && s ? k(t, o) : u ? C(t, a) : e === E ? U(t, o) : e === w && C(t, o))
                }
                var M = 0;
                ...
                function q(e, t) {
                    ...
                    } else C(this.promise, new Error("Array Methods must be provided an Array"))
                }
                q.prototype._enumerate = function () {
                    for (var e = this.length, t = this._input, r = 0; this._state === _ && r < e; r++) this._eachEntry(t[r], r)
                };
                q.prototype._eachEntry = function (t, e) {
                    ...
                    if (i === m) {
                        var n = b(t);
                        if (n === v && t._state !== _) this._settledAt(t._state, e, t._result);
                ...
                q.prototype._settledAt = function (e, t, r) {
                    var i = this.promise;
                    if (i._state === _) {
                        this._remaining--;
